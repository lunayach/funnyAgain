...
class S_bert_not_finetuend_Data(Dataset):
    ...
    def __init__(self, train=False, val=False, test=False):
        ...
        # data_file = '/home/speed/PycharmProjects/transformers/examples/old_best_Roberta_finetuned_task-2_test.hdf5'
        # id_list = open('/home/speed/PycharmProjects/transformers/examples/task-2_ids_test.txt', 'r')
